...
from switchboard.config import CONFIG, SETTINGS, CONFIG_MGR, CONFIG_SUFFIX
...
class UnrealAutoConfigScript(SwitchboardScriptBase):
    ...
    def on_postinit(self, app: SwitchboardDialog):
        ...
        if not config_name:
            config_name = CONFIG_MGR.config_dir / 'auto' / f'auto_{uuid.uuid4().hex}{CONFIG_SUFFIX}'
        ...
        app.refresh_levels_incremental()
