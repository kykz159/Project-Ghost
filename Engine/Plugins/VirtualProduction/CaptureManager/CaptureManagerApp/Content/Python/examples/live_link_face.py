...
def main():
    parser = argparse.ArgumentParser(description='Example Live Link Face device ingest', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    ...
    with UnrealEndpointManager(connect_timeout=10) as endpoint_manager:
        ...
        settings.download_directory = os.path.join(tempfile.gettempdir(), 'ScriptedIngestDownload')
