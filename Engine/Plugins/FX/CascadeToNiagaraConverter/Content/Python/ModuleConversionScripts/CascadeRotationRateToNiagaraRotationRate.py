...
class CascadeRotationRateConverter(ModuleConverterInterface):
    ...
    def convert(cls, args):
        ...
        rotation_rate_multiply_life_module = args.find_cascade_module(ue.ParticleModuleRotationRateMultiplyLife)
        if rotation_rate_multiply_life_module:
            life_multiplier = ueFxUtils.get_particle_module_rotation_rate_multiply_life_props(rotation_rate_multiply_life_module)
            ...
            multiply_float_script.set_parameter("A", life_multiplier_input)
            multiply_float_script.set_parameter("B", rotation_from_spawn_input)
