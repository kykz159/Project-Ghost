...
class CascadeBeamTypeDataConverter(RendererConverterInterface):

    @classmethod
    def get_input_cascade_module(cls):
        return ue.ParticleModuleTypeDataBeam2
    ...
    def convert(cls, cascade_typedata_module, cascade_required_module,
        ...
        #  ) = ueFxUtils.get_particle_module_type_data_ribbon_props(cascade_typedata_module)
        ...
        # behavior
        ribbon_renderer_props.set_editor_property("FacingMode", ue.NiagaraRibbonFacingMode.CUSTOM)
        
        # default ribbon particle sort ordering to front-to-back
        ribbon_renderer_props.set_editor_property("DrawDirection", ue.NiagaraRibbonDrawDirection.FRONT_TO_BACK)
        ...
        # cascade behavior
        ribbon_renderer_props.set_editor_property("TessellationMode", ue.NiagaraRibbonTessellationMode.CUSTOM)
        ...
        # ribbon_renderer_props.set_editor_property("TessellationAngle", 180.0/tangent_tessellation_scalar) 
        
        ribbon_renderer_props.set_editor_property("bScreenSpaceTessellation", False)
        ...
        script_asset = ueFxUtils.create_asset_data(Paths.script_spawn_beam)
        script_args = ue.CreateScriptContextArgs(script_asset)
        niagara_emitter_context.find_or_add_module_script(
            "SpawnBeam", 
            script_args,
