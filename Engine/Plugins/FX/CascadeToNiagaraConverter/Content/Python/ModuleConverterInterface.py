...
class ModuleConverterArgs:
    ...
    def __init__(
        ...
        self.__all_cascade_modules = all_cascade_modules
    ...
    def get_all_cascade_modules(self) -> list[ue.ParticleModule]:
        return self.__all_cascade_modules
    
    def find_cascade_module(self, _class) -> ue.ParticleModule:
        return next((m for m in self.__all_cascade_modules if isinstance(m, _class)), None)
